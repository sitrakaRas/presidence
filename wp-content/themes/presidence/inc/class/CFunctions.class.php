...
class CFunctions {
  ...
  function add_front_scripts() {
    wp_enqueue_style('custom-vendor', get_stylesheet_directory_uri() . '/styles/vendor.css?' . time());
    wp_enqueue_style('custom-main', get_stylesheet_directory_uri() . '/styles/main.css?' . time());
    wp_enqueue_style('custom-front-style', get_stylesheet_directory_uri() . '/styles/custom-style.css?' . time());
    wp_enqueue_script('custom-vendor', get_stylesheet_directory_uri() . '/scripts/vendor.js?' . time(), array(), FALSE, TRUE);
    wp_enqueue_script('custom-plugins', get_stylesheet_directory_uri() . '/scripts/plugins.js?' . time(), array(), FALSE, TRUE);
    wp_enqueue_script('custom-main', get_stylesheet_directory_uri() . '/scripts/main.js?' . time(), array(), FALSE, TRUE);
