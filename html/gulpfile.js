// generated on 2017-01-11 using generator-webapp 2.2.0
...
gulp.task('sprite',() => {
  var test = gulp.src('app/images/origin/*.{png,jpg,gif}')
    .pipe($.plumber({
...
gulp.task('images', () => {
  return gulp.src(['app/images/**/*','!app/images/origin{,/**}'])
    .pipe($.cache($.imagemin()))
...
gulp.task('serve', () => {
  runSequence(['clean', 'wiredep'], ['sprite','styles', 'scripts', 'fonts'], () => {
    browserSync({
      notify: false,
      port: 7000,
      server: {
